...
__C.PascalVOC.CLASSES = ['aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow',
                         ...
                         'tvmonitor']
# Pascal VOC 2011 dataset with keypoint annotations
__C.PascalVOC_dummy = edict()
__C.PascalVOC_dummy.KPT_ANNO_DIR = 'data/PascalVOC/annotations/'  # keypoint annotation
__C.PascalVOC_dummy.ROOT_DIR = 'data/PascalVOC/VOC2011/'  # original VOC2011 dataset
__C.PascalVOC_dummy.SET_SPLIT = 'data/PascalVOC/voc2011_pairs.npz'  # set split path
__C.PascalVOC_dummy.CLASSES = ['aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow',
                         'diningtable', 'dog', 'horse', 'motorbike', 'person', 'pottedplant', 'sheep', 'sofa', 'train',
                         'tvmonitor']
